namespace WEBPCTSV
{
    ...
    public class RouteConfig
    {
        public static void RegisterRoutes(RouteCollection routes)
        {
            ...
            routes.MapRoute("ManageNews", "QuanLy/QuanLyTinTuc", new { controller = "ManageNews", action = "News" });
            routes.MapRoute(
                "AddNews",
            ...
            routes.MapRoute("LoginAdmin", "QuanLy", new { controller = "Account", action = "LoginAdmin" });
            routes.MapRoute("LoginAdminOldRoute", "Admin", new { controller = "Account", action = "LoginAdmin" });
            routes.MapRoute(
                "Profile",
                "QuanLy/ThongTin",
            ...
            routes.MapRoute("ClientLogin", "Login", new { controller = "Account", action = "Login" });
            routes.MapRoute("ClientLoginAjax", "LoginAjax", new { controller = "Account", action = "LoginAjax" });
            routes.MapRoute("ClientLogout", "Logout", new { controller = "Account", action = "Logout" });

            #endregion

            #region controller conduct

            routes.MapRoute("ClientConductHome", "DanhGiaRenLuyen", new { controller = "Conduct", action = "Home" });
            routes.MapRoute(
            ...
            routes.MapRoute("ClientListNews", "ThongBao", new { controller = "News", action = "ListNews" });
            routes.MapRoute("ClientDetailNews", "ThongBao/ChiTiet", new { controller = "News", action = "DetailNews" });
            ...
            routes.MapRoute("ClientAlumniIntro", "CuuSinhVien", new { controller = "News", action = "AlumniIntro" });
            routes.MapRoute(
                "ClientAlumniStar",
            ...
            routes.MapRoute("ClientNewsEvent", "SuKien", new { controller = "NewsEvent", action = "ListNewsEvent" });
            routes.MapRoute(
            ...
            routes.MapRoute("ClientNewsJob", "TuyenDung", new { controller = "NewsJob", action = "ListNewsJob" });
            routes.MapRoute(
                "ClientDetailNewsJob",
                "TuyenDung/ChiTiet",
            ...
            routes.MapRoute("ClientDocument", "VanBanBieuMau", new { controller = "Document", action = "ListDocument" });
            routes.MapRoute(
            ...
            routes.MapRoute("ClientHome", "TrangChu", new { controller = "Home", action = "Index" });
            routes.MapRoute(
                name: "Default",
